...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="getCode?"+new Date().getTime();
		});
    ...
    <form id="form" class="form form-horizontal" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="username" name="username" type="text" placeholder="账户" value="zycc" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-8">
          <input id="password" name="password" type="password" placeholder="密码" value="zycc" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          <input class="input-text size-L" name="vcode" type="text" placeholder="请输入验证码" style="width: 200px;">
          <img title="点击图片切换验证码" id="vcodeImg" src="getCode"></div>
      </div>
...
<div class="footer">Copyright &nbsp; 2019/11/11 @ zyc </div>
